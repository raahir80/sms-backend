...
const { adminRegisterStudent, loginStudent, getStudentProfile, getAllStudentByAdmin, getStudent, getStudentByAdmin, studentUpdateProfile, adminUpdateStudent, writeExam } = require("../../controller/students/studentsCtrl");
